...
_TESTONEOF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='oneof_null_value', full_name='proto3.TestOneof.oneof_null_value', index=5,
...
_TESTONEOF.fields_by_name['oneof_null_value'].enum_type = google_dot_protobuf_dot_struct__pb2._NULLVALUE
...
_TESTONEOF.oneofs_by_name['oneof_value'].fields.append(
  _TESTONEOF.fields_by_name['oneof_null_value'])
_TESTONEOF.fields_by_name['oneof_null_value'].containing_oneof = _TESTONEOF.oneofs_by_name['oneof_value']
