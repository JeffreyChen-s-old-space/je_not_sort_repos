...
_LOGSEVERITY = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="DEBUG", index=1, number=100, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="INFO", index=2, number=200, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NOTICE", index=3, number=300, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="WARNING", index=4, number=400, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ERROR", index=5, number=500, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CRITICAL", index=6, number=600, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ALERT", index=7, number=700, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EMERGENCY", index=8, number=800, serialized_options=None, type=None
        ),
    ],
