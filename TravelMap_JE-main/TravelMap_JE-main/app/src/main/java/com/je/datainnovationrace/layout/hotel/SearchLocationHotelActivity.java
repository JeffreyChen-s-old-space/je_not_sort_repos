...
public class SearchLocationHotelActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_location_hotel);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.searchLocationHotelButton) {
            ...
            websocket = new Websocket(uri, this) {
                ...
                public void onMessage(String message) {
                    ...
                    String[] filedName = {
                            ...
                            getResources().getString(R.string.Grade),
                            ...
                            "",
                            "",
                            getResources().getString(R.string.Serviceinfo),
                            getResources().getString(R.string.Parkinginfo),
                            getResources().getString(R.string.TotalNumberofRooms),
                            getResources().getString(R.string.LowestPrice),
                            getResources().getString(R.string.CeilingPrice),
                            getResources().getString(R.string.IndustryEmail),
                            getResources().getString(R.string.TotalNumberofPeople),
                            getResources().getString(R.string.AccessibilityRooms),
                            getResources().getString(R.string.PublicToilets),
                            getResources().getString(R.string.LiftingEquipment),
                            getResources().getString(R.string.ParkingSpace)};
    ...
    private void setView() {
        ContextCompat.getMainExecutor(SearchLocationHotelActivity.this).execute(() -> {
