...
public class SearchLocationAttractionsActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_location_attractions);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.searchLocationAttractionsButton) {
            URI uri = URI.create("ws://jechen.ddns.net:30002");
            websocket = new Websocket(uri, this) {
                ...
                public void onMessage(String message) {
                    ...
                    String temp;
                    String[] filedName = {
                            getResources().getString(R.string.Toldescribe),
                            ...
                            getResources().getString(R.string.Travellinginfo),
                            ...
                            "",
                            "",
                            getResources().getString(R.string.Ticketinfo),
                            getResources().getString(R.string.Remarks),
                            getResources().getString(R.string.Keyword)};
    ...
    private void setView() {
        ContextCompat.getMainExecutor(SearchLocationAttractionsActivity.this).execute(() -> {
